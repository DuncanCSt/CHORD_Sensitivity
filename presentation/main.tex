...
\author[Duncan Cameron-Steinke]{Duncan Cameron-Steinke\\[1ex] {\small Supervisor: Dr.~Alex Hill}}
\date{July 30, 2026}
...
\begin{frame}{The Canadian Hydrogen Observatory and Radio-transient Detector (CHORD)}{}
  \begin{columns}[T]
    ...
    \begin{column}{0.4\linewidth}
      ...
      \par\medskip
      {\footnotesize CHORD is situated at the Dominion Radio Astrophysical Observatory (DRAO) near Penticton, British Columbia, Canada \cite{SPIEpaper}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{The Interstellar Medium (ISM)}{}
  \begin{columns}[T]
    ...
    \begin{column}{0.5\linewidth}
      ...
      \par\medskip
      {\footnotesize All-sky map of H$\alpha$ emission in the visible spectrum showing the ionized ISM \cite{haffnerEarlyResultsWisconsin2010}.}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Definition of RFI}{}
  \begin{columns}[T]
    \begin{column}{0.5\linewidth}
      \begin{itemize}
        \item Radio Frequency Interference (RFI) are unwanted man-made signals.
    ...
    \begin{column}{0.45\linewidth}
      ...
      \par\medskip
      {\footnotesize Sources of RFI can include satellites, aircraft, mobile phones, and cars. \cite{RFI_image}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{RFI-Monitor Data}{}
  \begin{columns}[T]
    ...
    \begin{column}{0.45\linewidth}
      ...
      \par\smallskip
      \includegraphics[width=0.65\linewidth]{plots/RFI_monitor.png}
      \par\medskip
      {\footnotesize The roof mounted DRAO RFI-Monitor which measures all incoming radio signals \cite{bruceWidebandRFIMonitor2026}.}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{RFI Detection}{}
  \begin{columns}[T]
    \begin{column}{0.5\linewidth}
      I applied the generalized Spectral Kurtosis (SK) \cite{nitaGeneralizedSpectralKurtosis2010} estimator to detect RFI.
      \begin{itemize}
...
\begin{frame}{Detection Results}{}
  \begin{columns}[T]
    \begin{column}{0.5\linewidth}
      \begin{itemize}
        \item I obtained RFI flags for the entire CHORD band and found that 75.6\% of the band is RFI free.\\
      \end{itemize}
      \par\medskip
      How does this impact RRL detection?
      \par\medskip
      \begin{itemize}
        \item I computed a gaussian weighted average around each RRL and found that 79 of the 116 Hn$\alpha$ RRLs remain visible.
      \end{itemize}
    \end{column}
    \begin{column}{0.5\linewidth}
      \centering
      ...
      \par\smallskip
      \includegraphics[width=1\linewidth, clip,trim=0 0 0 31.7pt]{../thesis/plots/rfi/RFI_flagged_spectrum.png}
      \par\medskip
      {\footnotesize RFI monitor power colored by SK RFI flagging results.}
    \end{column}
  \end{columns}
\end{frame}
...
\section{Sensitivity}
\subsection{CHORD sensitivity to RRLs}
