...
\title{Radio Recombination Line Forecasts with the Canadian Hydrogen Observatory and Radio-transient Detector (CHORD)}
%\subtitle{With a Subtitle}
\author{Duncan Cameron-Steinke} % The name needs to be exactly the same as on the diploma i.e. (Name from SISC)
\copyrightyear{2026}
\submitdate{July 2026} % date of approved thesis
\program{Mathematics}%or Mathematics, or Interdisciplinary Studies
\previousdegree{B.Sc., Queen's University, 2020}
...
\newcommand{\UV}{\ensuremath{\, \mathrm{(u,v)}}}
...
\chapter{Simulations}
\input{thesis/3_Simulations/SIGGMA}

\chapter{Conclusion}
\input{thesis/4_Conclusions/conclusions}

\include{thesis/bibliography}
\include{thesis/appendices/appendix_main}
