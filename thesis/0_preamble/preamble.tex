...
\noindent\underline{Timothy Robishaw, Irving K. Barber Faculty of Science} 
\\
\textbf{Supervisory Committee Member}
...
\begin{abstract}
The Canadian Hydrogen Observatory and Radio-transient Detector \\(CHORD) is a radio telescope under construction at the Dominion Radio Astrophysical Observatory (DRAO) near Penticton, British Columbia. A scientific goal for the telescope is to map the extremely faint radio waves originating from distant gas clouds in our Milky Way Galaxy. To accomplish this, the telescope must be extremely sensitive at specific radio frequencies. In this thesis, we analyze which frequencies are usable by CHORD and which are corrupted by interference from terrestrial radio emitters. We calculate the theoretical sensitivity which we expect CHORD to achieve and provide data processing strategies that can improve sensitivity. We study the impact of adding additional antennas to CHORD and propose a design which optimizes scientific outcomes. Finally, we compare the expected performance of CHORD to previously published surveys and find that CHORD is likely to be more precise, likely allowing for new scientific discoveries.
\end{abstract}

\chapter{Preface}
This thesis was wholly written by Duncan Cameron-Steinke, who also performed all of the analysis presented in this thesis. This work was supervised by Dr. Alex Hill, with additional guidance from Dr. John Braun and Dr. Tim Robishaw. Dr. Nicholas Bruce assisted in the technical description of the RFI monitor and provided guidance for data processing of the RFI monitor data. Dr. Théo Michelot previously served as a committee member and provided continued guidance and support.\\

Generative AI in the form of Claude Code Opus 4.8 was used to accomplish specific, tightly scoped, coding tasks, such as generating plots and debugging. I carefully reviewed all generated code to ensure correctness and accuracy. Generative AI in the form of Claude Code Opus 4.8 was used to edit versions of this thesis for grammar, clarity and to review accuracy of stated concepts and mathematical derivations. Generative AI was used as a resource while researching this thesis to provide background and answer questions.\\

Generative AI was not used to write any sections of this thesis and was not used to accomplish any of the analysis presented in the thesis. 
...
Thank you to my committee members for their guidance and support throughout my research. To Dr. John Braun thank you for the statistical feedback, to Dr. Tim Robishaw thanks for the detailed review which greatly improved this work, and to Dr. Théo Michelot thanks for your mentorship and encouragement which allowed me to expand my research scope.\\

Thank you to all the members of the UBCO/UofC ISM group, Dr. Anna Ordog, Dr. Tom Landecker, Dr. Jo-Anne Brown, Dr. Jennifer West, Dr. Rebecca Booth, Ciara Chisholm, Artem Davydov, Dr. Josh MacEachern, and Veyanna Hassani, for the many reviews and discussions.\\

Thank you to the CHORD spectral lines group, Dr. Kristine Spekkens, Akanksha Bij, Hans Hopkinson, and Josh Goodeve, for your contributions.


\chapter{Dedication} % Optional
To Rebeka, thank you for your unwavering support.
