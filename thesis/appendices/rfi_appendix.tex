...
\noindent\textbf{Claim.} A normalized gamma distribution approaches a Gaussian distribution for shape parameter $N \gg 1$.\\
...
\begin{table}[h!]
\centering
\caption[Detectable RRLs by aggregation and SK threshold]{Number of detectable hydrogen RRLs per frequency region, by cross-segment aggregation method (any/50\%/all) and spectral kurtosis threshold (0.1\%, 0.5\%, 1\%).}
