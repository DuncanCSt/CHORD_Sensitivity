...
While line emission from a source at rest should classically occur only at the specific frequency characterized by the Rydberg formula of equation \eqref{eq:rydberg_formula}, when measuring a line emission produced by an astronomical source the line will be broadened in its frequency profile to a shape approximately Gaussian characterized by its FWHM line width \(\Delta V\). The line broadening is caused by a combination of thermal broadening, the random motion of electrons, turbulence, the bulk motion of the gas, and pressure broadening, the perturbations of energy levels between closely packed neighboring particles.\\

The integrated line intensity, which is the line intensity integrated over the line width, which eliminates the dependence on \(\Delta V\), is further shown by \citet{andersonGBTDiffuseIonized2021} to be
\begin{equation}
