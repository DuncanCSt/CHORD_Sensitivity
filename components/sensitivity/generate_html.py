...
synthesized-beam solid angle and applying the Rayleigh&ndash;Jeans limit:</p>
$$\\sigma_T\\,[\\mathrm{{K}}] = \\frac{{\\sigma_{{\\mathrm{{RMS}}}}}}{{\\Omega_s}}\\,
\\frac{{c^2}}{{2k\\nu^2}}$$
<p>where \\(\\Omega_s\\) is the synthesized-beam solid angle, \\(c\\) is the speed of light, and
